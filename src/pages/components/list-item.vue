<template>
  <base-page :title="title">
    <p class="margin">功能实用的列表组件，listItem通常与list组件搭配使用</p>
    <f7-block-title>简单的列表</f7-block-title>
    <f7-list simple-list>
      <f7-list-item title="Item 1"></f7-list-item>
      <f7-list-item title="Item 2"></f7-list-item>
      <f7-list-item title="Item 3"></f7-list-item>
    </f7-list>
    <f7-block-title>带跳转的简单列表</f7-block-title>
    <f7-list>
    ...
    <f7-block-title>带图标的数据列表</f7-block-title>
    <f7-list>
    ...
    <f7-block-title>路由跳转列表</f7-block-title>
    <f7-list>
