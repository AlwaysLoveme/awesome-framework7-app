<template>
  <base-page :title="title" @page:beforeout="onPageBeforeRemove">
    <f7-block strong>
      Popup分两种打开方式，有组件方式，也有API指令创建方式
      <p>
        更多用法参考：<f7-link
          href="https://framework7.io/vue/popup.html"
          text="https://framework7.io/vue/popup.html"
          external
        ></f7-link>
      </p>
    </f7-block>
    <f7-block>
      <p>
        <f7-button fill large popup-open=".demo-popup">组件打开</f7-button>
      </p>
      <p>
        <f7-button fill large @click="popupOpened = true">
          Open Via Prop Change
        </f7-button>
      </p>
      <p>
        <f7-button fill large @click="createPopup">API创建</f7-button>
      </p>
      <p>
        <f7-button fill large popup-open=".demo-popup-swipe">
          Swipe To Close
        </f7-button>
      </p>
      <p>
        <f7-button fill large popup-open=".demo-popup-swipe-handler">
          With Swipe Handler
        </f7-button>
      </p>
      <p>
        <f7-button fill large popup-open=".demo-popup-push">
          Popup Push
        </f7-button>
      </p>
    </f7-block>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onPageBeforeRemove = () => {
      if (popup.value) popup.value.destroy();
    };
    return {
      createPopup,
      popupOpened,
