<template>
  <base-page :title="title">
    <f7-block strong>
      更多用法参考：<f7-link
        href="https://framework7.io/vue/radio.html"
        text="https://framework7.io/vue/radio.html"
        external
      ></f7-link>
    </f7-block>
    ...
    <f7-block strong>
      <p>
        Lorem <f7-radio name="demo-radio-inline" checked></f7-radio> ipsum dolor
        sit amet, consectetur adipisicing elit. Alias beatae illo nihil aut eius
