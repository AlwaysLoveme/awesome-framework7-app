<template>
  <base-page :title="title">
    <f7-block strong>
      <p>
        更多用法参考：<f7-link
          href="https://framework7.io/vue/treeview.html"
          text="https://framework7.io/vue/treeview.html"
          external
        ></f7-link>
      </p>
    </f7-block>
          ...
          <f7-treeview-item label="avatar.png" icon-f7="photo_fill">
            <template #content-start>
              <f7-checkbox
                ...
                @change="
                  checkboxes.images['avatar.png'] = $event.target.checked
                "
              />
            </template>
          </f7-treeview-item>
          <f7-treeview-item label="background.jpg" icon-f7="photo_fill">
            <template #content-start>
              <f7-checkbox
                ...
                @change="
                  checkboxes.images['background.jpg'] = $event.target.checked
                "
              />
            </template>
          </f7-treeview-item>
          ...
          <f7-treeview-item label="cv.docx" icon-f7="doc_text_fill">
            <template #content-start>
              <f7-checkbox
                ...
                @change="
                  checkboxes.documents['cv.docx'] = $event.target.checked
                "
              />
            </template>
          </f7-treeview-item>
          <f7-treeview-item label="info.docx" icon-f7="doc_text_fill">
            <template #content-start>
              <f7-checkbox
                ...
                @change="
                  checkboxes.documents['info.docx'] = $event.target.checked
                "
              />
            </template>
          </f7-treeview-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const toggleSelectable = (e: Event, item: null) => {
      if (f7.$(e.target as EventTarget).is(".treeview-toggle")) return;
      state.selectedItem = item;
    };
    const loadChildren = function (e: Event, done: () => void) {
      setTimeout(function () {
